        ...
        <div class="container-fluid">
          <div class="card mt-5">
            <div class="row">
              ...
              <div class="col-4">
                <div class="w-75" style="margin: 0 0 10 0; ">
                  @if ($detailProduk->foto == null)
                    <div class="text-center">
                      <svg class="mx-auto" width="214" height="160" xmlns="http://www.w3.org/2000/svg">
                        <path
                      ...
                      <p class="font-semibold text-2xl opacity-50">Tidak Ada Foto</p>
                    </div>
                  @else
                  ...
                  <a href="{{ url('/admin/produk') }}">
                    <button class="btn btn-primary float-end mb-4">Kembali</button>
                  </a>
                </div>
              </div>
            </div>
