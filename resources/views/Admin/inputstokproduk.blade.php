        ...
        <div class="card w-50 m-auto bg-transparent shadow-none " >
          <form method="POST" action="{{ url('tambah-supplier') }}" enctype="multipart/form-data">
            ...
            <div class="modal-body">
              ...
              <div class="row align-items-center">
                <div class="col mb-2">
                <label for="alamat_supplier" name="alamat_supplier" class="form-label font-weight-normal">Tanggal Keluar </label>
              ...
              <div class="row align-items-center">
                <div class="col mb-2">
                <label for="alamat_supplier" name="alamat_supplier" class="form-label font-weight-normal">Tanggal Masuk </label>
                    <div class="input-group date" id="datepicker">
                        <input type="date" class="form-control" id="date"/>
                        <span class="input-group-append">
                        <span class="input-group-text bg-light d-block">
