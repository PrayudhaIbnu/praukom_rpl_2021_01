            ...
            <table class="table table-hover mt-4 ">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $item->username }}</td>
                  <td>
                    <button type="button" value="{{ $item->username }}" class="btn btn-edit btn-primary" ><i class="fa-solid fa-pen-to-square"></i></button>
            ...
            <div class="modal-body">
              ...
              <div class="row align-items-center">
                <div class="col mb-3">
                  ...
                  <input required name="nama" class="form-control form-control-sm" type="text" aria-label=".form-control-sm example">
                </div>
                <div class="col mb-3">
              ...
              <div class="row align-items-end">
                <div class="col mb-2">
                  ...
                  <input required name="username" class="form-control form-control-sm" type="text" aria-label=".form-control-sm example">
                </div>
                <div class="col mb-2">
                  <label for="password" class="form-label font-weight-normal">Password</label>
                  <input required name="password" class="form-control form-control-sm" type="password" aria-label=".form-control-sm example">
                </div>
              </div>
            </div>
          ...
          <form method="POST" action="{{ url('update-user') }}" enctype="multipart/form-data">
            ...
            <div class="modal-body">
              ...
              <div class="row align-items-center">
                <div class="col mb-3">
                  <label for="namauser" class="form-label font-weight-normal">Nama User</label>
                  <input required name="nama" id="nama" class="form-control form-control-sm" type="text" aria-label=".form-control-sm example">
                </div>
                <div class="col mb-3">
                  <label for="id_level" class="form-label font-weight-normal">Sebagai</label>
              ...
              <div class="row align-items-end">
                <div class="col mb-2">
                  <label for="username" class="form-label font-weight-normal">Username</label>
                  <input required name="username" id="username" class="form-control form-control-sm" type="text" aria-label=".form-control-sm example">
                </div>
                <div class="col mb-2">
                  <label for="password" class="form-label font-weight-normal">Password</label>
                  <input required name="password" id="password" class="form-control form-control-sm" type="password" aria-label=".form-control-sm example">
                </div>
              </div>
            </div>
            <div class="modal-footer">
    ...
    <script>
      $(document).ready(function () {
        ...
        $('.btn-edit').on('click', function () {
          ...
          .then(data => {
            const {user} = data;
            const { foto, id_user, level, nama, password, username } = user;
