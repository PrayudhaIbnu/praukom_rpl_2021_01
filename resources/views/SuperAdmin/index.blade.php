            ...
            <table class="table table-hover mt-4 ">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <button class="btn btn-edit btn-primary" data-toggle="modal" data-target="#edituser"><i class="fa-solid fa-pen-to-square"></i></button>
            ...
            <div class="modal-body">
              ...
              <div class="row align-items-center">
                <div class="col mb-3">
                  ...
                  <input required name="nama" class="form-control form-control-sm" type="text" id="namauser"aria-label=".form-control-sm example">
                </div>
                <div class="col mb-3">
              ...
              <div class="row align-items-end">
                <div class="col mb-2">
                  ...
                  <input required name="username" class="form-control form-control-sm" type="text" id="username"aria-label=".form-control-sm example">
                </div>
                <div class="col mb-2">
                  <label for="password" class="form-label font-weight-normal">Password</label>
                  <input required name="password" class="form-control form-control-sm" type="password" id="password"aria-label=".form-control-sm example">
                </div>
              </div>
            </div>
          ...
          <form method="POST" action="{{ url('edit-user') }}" enctype="multipart/form-data">
            ...
            <div class="modal-body">
              <div class="row align-items-start">
                <div class="col mb-3">
                  <label for="foto" class="form-label font-weight-normal">Foto User</label>
                  <input value="" required name="foto" class="form-control form-control-sm" id="foto"  type="file">
                </div>
              </div>
              <div class="row align-items-center">
                <div class="col mb-3">
