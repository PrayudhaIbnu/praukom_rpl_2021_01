    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        <span class="dropdown dropdown-header">
          ...
          @else
            <img src="{{ asset('storage/post-images/' . Auth::user()->foto) }}"
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        @can('admin')
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview pl-4">
              ...
              <li class="nav-item">
                <a href="/produkreject"
                  class="nav-link pl-3 {{ Request::path() === 'produkreject' ? 'bg-secondary' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{ route('supplier') }}"
              class="nav-link {{ Request::path() === 'supplier' ? 'bg-secondary' : '' }}">
        ...
        @can('kasir')
          ...
          <li class="nav-item">
            <a href="/riwayat-penjualan"
              class="nav-link {{ Request::path() === 'riwayat-penjualan' ? 'bg-secondary' : '' }}">
        ...
        @can('admin-pengawas')
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview pl-4">
              <li class="nav-item">
                <a href="/riwayat/barang-masuk"
                  class="nav-link {{ Request::path() === 'riwayat/barang-masuk' ? 'bg-secondary' : '' }}">
                  <i class="fa-solid fa-arrow-right-to-bracket"></i>
                  <p>Barang Masuk</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/riwayat/barang-keluar"
                  class="nav-link {{ Request::path() === 'riwayat/barang-keluar' ? 'bg-secondary' : '' }}">
                  <i class="fa-regular fa-circle-xmark"></i>
                  <p> Barang Keluar</p>
                </a>
              </li>
